...
**These env vars MUST be identical on all six chains:**
...
- **RPC URLs** for all six chains, exported as the env vars the `foundry.toml` aliases reference:
...
factory (`0x4e1DCf7AD4e460CfD30791CCC4F9c8a4f820ec67`) are already present on all six chains — no
